...
Further, it defines and registers the crs parameter for the HTTP Link header and suggests a best practice for the use of the new headers together with the Link header to perform content negotiation and point clients to alternate coordinate reference systems.
